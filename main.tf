...
###########################################################
# Variáveis (injetadas via -var do GitHub Actions)
###########################################################
variable "db_name" {
  type        = string
...
variable "db_password" {
  ...
  sensitive   = true
  default     = "AlterarSenha123"
}

###########################################################
# Hardcode do VPC, SG e Subnets
###########################################################
# Ajuste conforme a sua conta AWS.
locals {
...
###########################################################
# Locals para usar o SubnetGroup/Secret, caso já existam
###########################################################
locals {
...
resource "aws_db_instance" "fastfood_db" {
  ...
  # Torna o RDS publicamente acessível
  publicly_accessible  = true
  skip_final_snapshot  = true

  # Usa SG e SubnetGroup fixos
